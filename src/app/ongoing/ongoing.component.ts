...
//   if(Date.parse(this.mindateStart) >= Date.parse(this.currentDate)){
//     this.mindateStart = event.target.value;
//   }else{
...
createForm(){
  this.authForm = this.fb.group({
    ...
    availability_end_date: ['', Validators.compose([Validators.required])],
    availability_start_date: ['', Validators.compose([Validators.required])],
  });
...
getOngoingShifts() {
  ...
  this.shiftService.OngoingShiftsListAssigned(Data).subscribe((response) => {
    console.log(response);
...
updateShiftDetails(location, days){
  if(this.changedValue == 'ongoing'){
    ...
    this.shiftData = {
      ...
      location: this.authFormDays.value.location,
...
// };
 ...
 //    // days[0].start_time = Number(days[0].start_time);

 //    if(days[0].start_time_am_pm == '1'){
 //       days[0].start_time = Number(days[0].start_time) + 12;
 //    }else{
 //         days[0].start_time = Number(days[0].start_time);
 //    }

 //     if(days[0].end_time_am_pm == '1'){
 //       days[0].end_time = Number(days[0].end_time) + 12;
 //    }else{
 //         days[0].end_time = Number(days[0].end_time);
 //    }
 ...
 //        if(days[index].start_time_am_pm == 1){
 //       days[index].start_time = Number(days[index].start_time) + 12;
 //    }else{
 //         days[index].start_time = Number(days[index].start_time);
 //    }

 //     if(days[index].end_time_am_pm == 1){
 //       days[index].end_time = Number(days[index].end_time) + 12;
 //    }else{
 //         days[index].end_time = Number(days[index].end_time);
 //    }
